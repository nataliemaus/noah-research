...
track_run = False
use_vanilla_train_data = False

# for trip1 data, dec
# pretrained_model_path = "mdn_trained_models/mdn0_trainYdec_nepochs25_bsz128_lr0.001.pt"  # "None" #or "model_path"
# for mdn, trip1 data, reg
pretrained_model_path = "mdn_trained_models/mdn0_trainYreg_nepochs25_bsz128_lr0.001.pt" # "None" #or "model_path"

which_jtvae = "vanilla" # "vanilla", "trip1", "trip_best" (decoder in BO loop!)
which_train_y = "reg"  #dec or reg, preferable dec once I can!
num_epochs = 20  #num epochs to fit GP on each run .... 
samples_per_z = 40
